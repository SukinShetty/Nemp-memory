...
### Step 9: Auto-Sync to CLAUDE.md (if enabled)

After saving all memories, check if auto-sync is enabled:
...
3. Check if CLAUDE.md exists:
   ...
   - **If CLAUDE.md exists with Nemp section:** Replace the section
   - **If CLAUDE.md exists without Nemp section:** Append the Nemp section

4. Include in the completion message: `CLAUDE.md updated`
