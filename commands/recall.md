...
3. [key-three] - <truncated-value-preview>...
...
1. [auth-flow] - "Authentication uses JWT access tokens..."
2. [user-session-handling] - "Sessions expire after 30 days of inactivity..."
